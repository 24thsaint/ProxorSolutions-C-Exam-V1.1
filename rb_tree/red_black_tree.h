...
typedef struct rb_red_blk_tree {
  ...
  void (*PrintInfo)(void* a); /* BUG: should be const? */
  /*  A sentinel is used for root_parent and for nil.  These sentinels are */
  /*  created when RBTreeCreate is called.  root_parent->left should always */
  /*  point to the node which is the root of the tree.  nil points to a */
  /*  node which should always be black but has aribtrary children and */
  /*  parent and no key or info.  The point of using these sentinels is so */
  /*  that the root_parent and nil nodes do not require special cases in the code */
  rb_red_blk_node* root_parent;
  rb_red_blk_node* nil;              
} rb_red_blk_tree;
